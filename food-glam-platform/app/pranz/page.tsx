...
const TITLE = 'Rețete de Prânz'
const SUBTITLE = 'Descoperă rețete perfecte pentru prânz — salate consistente, sandvișuri gourmet, supe calde și boluri bogate în proteine pentru mijlocul zilei.'
const EMOJI = '🥙'
const SLUG = 'pranz'

export const metadata: Metadata = {
  title: `${TITLE} | MareChef.ro`,
  description: `${SUBTITLE} Peste 100 de rețete de prânz pe MareChef.ro.`,
  openGraph: {
    title: `${TITLE} | MareChef.ro`,
...
export default async function PranzPage() {

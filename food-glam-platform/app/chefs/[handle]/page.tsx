                          ...
                          {items.map(item => (
                            item.type === 'post' ? (
                              ...
                              <article
                                ...
                                style={{ background: '#161616', border: '1px solid rgba(255,255,255,0.07)', height: 200 }}
                              >
                                {/* Image — left */}
                                <Link href={`/recipes/${item.data.slug}`} className="flex-shrink-0 relative overflow-hidden" style={{ width: 220 }}>
                                  <img

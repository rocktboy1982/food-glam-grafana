...
const MEAL_TYPE = 'appetiser'
const TITLE = 'Rețete de Aperitive'
const SUBTITLE = 'Impresionează-ți invitații! Bruschete, mezze, tapas, dip-uri cremoase și tartine elegante — aperitive pentru orice ocazie.'
const EMOJI = '🥗'
const SLUG = 'aperitive'

export const metadata: Metadata = {
  title: `${TITLE} | MareChef.ro`,
  description: `${SUBTITLE} Peste 100 de rețete de aperitive pe MareChef.ro.`,
  openGraph: {
    title: `${TITLE} | MareChef.ro`,
...
export default async function AperitivePage() {

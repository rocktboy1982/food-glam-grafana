...
const TITLE = 'Rețete de Cină'
const SUBTITLE = 'Pregătește cina perfectă! De la paste și curry-uri aromate la fripturi și preparate tradiționale — rețete pentru fiecare seară.'
const EMOJI = '🍽️'
const SLUG = 'cina'

export const metadata: Metadata = {
  title: `${TITLE} | MareChef.ro`,
  description: `${SUBTITLE} Sute de rețete de cină pe MareChef.ro.`,
  openGraph: {
    title: `${TITLE} | MareChef.ro`,
...
export default async function CinaPage() {

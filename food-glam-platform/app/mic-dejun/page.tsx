...
const TITLE = 'Rețete de Mic Dejun'
const SUBTITLE = 'Începe dimineața cu energie! Descoperă rețete delicioase de mic dejun — de la ouă benedict și clătite pufoase la smoothie-uri hrănitoare și granola crocantă.'
const EMOJI = '🥐'
const SLUG = 'mic-dejun'

export const metadata: Metadata = {
  title: `${TITLE} | MareChef.ro`,
  description: `${SUBTITLE} Peste 100 de rețete de mic dejun pe MareChef.ro.`,
  openGraph: {
    title: `${TITLE} | MareChef.ro`,
...
export default async function MicDejunPage() {

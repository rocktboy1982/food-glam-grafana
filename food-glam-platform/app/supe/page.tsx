...
const MEAL_TYPE = 'soup'
const TITLE = 'Rețete de Supe și Ciorbe'
const SUBTITLE = 'Nimic nu se compară cu o supă caldă! Ciorbe tradiționale românești, supe cremă, ramen, pho și borscht — comfort food în cel mai bun mod.'
const EMOJI = '🍲'
const SLUG = 'supe'

export const metadata: Metadata = {
  title: `${TITLE} | MareChef.ro`,
  description: `${SUBTITLE} Peste 100 de rețete de supe și ciorbe pe MareChef.ro.`,
  openGraph: {
    title: `${TITLE} | MareChef.ro`,
...
export default async function SupePage() {

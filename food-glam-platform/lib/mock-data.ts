...
export const MOCK_APPROACHES = [
  { id: 'asian', name: 'Asian', slug: 'asian', description: 'Cuisines from East, Southeast, and South Asia' },
  { id: 'european', name: 'European', slug: 'european', description: 'Traditional European cooking styles' },
  { id: 'african', name: 'African', slug: 'african', description: 'Diverse African culinary traditions' },
  { id: 'latin-american', name: 'Latin American', slug: 'latin-american', description: 'Central and South American cuisines' },
  { id: 'american', name: 'American', slug: 'american', description: 'North American cooking styles' },

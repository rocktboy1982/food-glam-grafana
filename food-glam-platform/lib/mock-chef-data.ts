...
export const MOCK_CHEF_PROFILES: ChefProfile[] = [
  ...
  },
  {
    ...
    bio: 'Third-generation West African chef and food historian based in Accra, Ghana. 12+ years specialising in authentic Ghanaian and Senegalese cuisine. Passionate about preserving culinary heritage while making traditional dishes accessible to modern home cooks.',
    follower_count: 21300,
    following_count: 94,
    post_count: 6,
    is_following: false,
...
export const MOCK_CHEF_POSTS: ChefBlogPost[] = [
  ...
  },
  {
    ...
    description: 'Mafé is the dish I cook when I want to take someone on a journey. The peanut base is everything — rich, earthy, slightly bitter. We add fermented locust beans (dawadawa) for depth that you simply cannot replicate with anything else. This vegetarian version uses mushrooms and firm tofu to mimic the body of the traditional lamb. Serve over rice or fonio.',
    created_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
    votes: 44,
    comments: 11,
  },
  {
    ...
    description: 'There is no dish that sparks more argument in West Africa than jollof rice. Ghana versus Nigeria — a debate with no end and no wrong answer. My version is Ghanaian, obviously. Long-grain parboiled rice, a blended tomato-pepper base, and patience. Do not stir it too often. The bottom crust — we call it kanzo in Ghana — is not a mistake. It is the prize.',
    created_at: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(),
    votes: 89,
    comments: 23,
  },
  {
    ...
    description: 'Waakye is Ghana\'s great street food. Rice and black-eyed peas cooked together with dried sorghum stems — the stems give the dish its distinctive earthy purple-brown colour and a subtle mineral flavour. You will find it sold from large pots on street corners at dawn. This is the recipe I have refined over years of eating it at those same street corners.',
